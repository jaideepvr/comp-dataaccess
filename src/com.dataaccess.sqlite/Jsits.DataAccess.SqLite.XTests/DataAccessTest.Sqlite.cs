using Jsits.DataAccess.Core.XTests;
using Jsits.DataAccess.XTests.DataFixtures;
using Xunit;

namespace Jsits.DataAccess.Sqlite.XTests
{
    public class SqliteDataAccessTest: DataAccessTestBase, IClassFixture<SqliteDataFixture>
    {

        protected override string ConnectionString => @"provider=Jsits.DataAccess.Sqlite; provider connection string='URI=file:E:\Projects\Gvs\Common\SQLiteDB\test.db';";
