...
namespace JV.DataAccess.Mysql.XTests
{
    public class MysqlDataAccessTest: DataAccessTestBase, IClassFixture<MysqlDataFixture>
    {

        protected override string ConnectionString => "provider=JV.DataAccess.Mysql; provider connection string='Server=****;Database=abc;Uid=***;Pwd=*****';";
